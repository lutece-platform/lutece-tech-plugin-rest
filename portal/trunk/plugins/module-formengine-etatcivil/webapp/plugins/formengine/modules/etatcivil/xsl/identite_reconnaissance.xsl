 ...
 <xsl:template match="formElements">
   ...
   <fieldset class="formengine-fieldset">
    <legend class="formengine-legend"> Spécifier l'identité du ou des auteurs de la reconnaissance :</legend>
     ...
     <xsl:apply-templates select="notices/noticeGroup[@name='remarqueIdentiteParent']" mode="no-bullet" />
    ...
    <legend class="formengine-legend">Informations :</legend>
      <xsl:apply-templates select="notices/noticeGroup[@name='conditionsDelivrance']" mode="no-bullet" />
  </fieldset>
