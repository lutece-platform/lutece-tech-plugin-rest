 ...
 <xsl:template match="formElements">
  ...
  <fieldset class="formengine-fieldset">
      <legend class="formengine-legend">Type d'acte demandé :</legend>
        ...
        <h3>Remarques :</h3>
        <xsl:apply-templates select="notices/noticeGroup[@name='remarquesTypesActes']"/>
  ...
  <fieldset class="formengine-fieldset">
     ...
     <xsl:apply-templates select="notices/noticeGroup[@name='informations']" mode="no-bullet" />
