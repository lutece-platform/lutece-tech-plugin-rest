...
<%
response.sendRedirect( amendement.doPublicationVoeuAmendement( request, fr.paris.lutece.plugins.ods.web.voeuamendement.VoeuAmendementJspBean.CONSTANTE_TYPE_A ));
%>
