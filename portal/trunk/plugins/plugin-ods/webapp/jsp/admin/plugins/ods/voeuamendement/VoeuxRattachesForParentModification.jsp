...
<%=amendement.getVoeuAmendementList(
		...
		fr.paris.lutece.plugins.ods.web.voeuamendement.VoeuAmendementJspBean.CONSTANTE_URL_JSP_APPELANT_VOEU_RATTACHE_PARENT_MODIFICATION,
		fr.paris.lutece.plugins.ods.web.voeuamendement.VoeuAmendementJspBean.CONSTANTE_URL_JSP_RETOUR_PARENT_MODIFICATION_VOEU_RATTACHE) %>
