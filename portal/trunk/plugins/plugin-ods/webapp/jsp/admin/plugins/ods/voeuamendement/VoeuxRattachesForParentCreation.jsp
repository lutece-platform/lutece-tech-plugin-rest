...
<%=amendement.getVoeuAmendementList(
		...
		fr.paris.lutece.plugins.ods.web.voeuamendement.VoeuAmendementJspBean.CONSTANTE_URL_JSP_APPELANT_VOEU_RATTACHE_PARENT_CREATION,
		fr.paris.lutece.plugins.ods.web.voeuamendement.VoeuAmendementJspBean.CONSTANTE_URL_JSP_RETOUR_PARENT_CREATION_VOEU_RATTACHE) %>
