...
<!--  TODO : change form definition : if at least one  field[@type='upload'] then add enctype="multipart/form-data" -->
	...
	<form action="{$actionUrl}" id="{$formName}{$subFormName}" name="{$formName}{$subFormName}" enctype="multipart/form-data"  method="post" class="formengine-form" >
	...
	<xsl:template match="field[@type='upload']">
			...
			<div class="formengine-element">
				...
				<span class="formengine-field" >
					<input type="submit" name="{$uploadSubmitPrefix}{@name}" value="Transmettre" class="formengine-submit"/>
				</span>
			</div>
    		<xsl:if test="count(fileNames/fileName)>0">
				...
				<div class="formengine-element">
					...
					<span class="formengine-field" >
						<input type="submit" name="{$uploadDeletePrefix}{@name}" value="Supprimer" class="formengine-submit"/>
					</span>
				</div>
			</xsl:if>
